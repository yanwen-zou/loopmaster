# Plan: drive chassis x=0.1 y=0.0 theta=0.0 and capture front camera

## Goal
drive chassis x=0.1 y=0.0 theta=0.0 and capture front camera
...
3. `set_base_velocity` args={'x': 0.1, 'y': 0.0, 'theta': 0.0} - execute explicitly requested chassis velocity
